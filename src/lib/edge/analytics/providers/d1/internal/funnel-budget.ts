import { MAX_FUNNEL_STEPS } from "@/lib/edge/analytics/contract/funnel-config";

/** D1's safe statement parameter cap for funnel analysis. */
...
/** Bounds for the ten-step D1 funnel query shape. */
...
/** Fixed one-site visit and event source binding budget. */
