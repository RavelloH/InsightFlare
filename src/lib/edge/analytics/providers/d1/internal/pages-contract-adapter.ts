...
export async function handlePagesContract(
  ...
  const result = await executeTypedApplicationResult<PagesResult>(
    "pages",
    { context: queryContext, time, filters },
    createTypedQueryResultProviderRegistry("pages", () =>
...
export async function handleReferrersContract(
  ...
  const result = await executeTypedApplicationResult<ReferrersResult>(
    "referrers",
    { context: queryContext, time, filters },
    createTypedQueryResultProviderRegistry("referrers", () =>
