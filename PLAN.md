...
- 网络地理（来自 `request.cf`）：`asOrganization`、`country`、`isEUCountry`、`city`、`continent`、`latitude`、`longitude`、`postalCode`、`metroCode`、`region`、`regionCode`、`timezone`、`colo`
...
5. 公开站点脱敏范围
- 隐藏 `query/hash` 详情、独立访客轨迹、详细 referrer URL。
